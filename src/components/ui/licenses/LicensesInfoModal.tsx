...
export default function LicensesInfoModal() {
  ...
  const showModal = searchParams.get("showLicenceInfoModal");
        ...
        <div className="flex flex-col justify-center">
          <div className="flex flex-row justify-between items-center sticky -top-1 pt-2 pb-6 bg-[#080808] border-b-2 border-[#8A0303]">
            ...
            <Link
              ...
              className="h-[25px] sm:h-[45px]"
              onClick={closeModal}
            >
              <Icons.close />
            </Link>
          </div>
          <div className="flex flex-col space-y-4 font-light text-[0.9rem] sm:text-xl">
